...
namespace gui
{
	...
	public:
		...
		TEXTURE2D_D3D11* get_viewport( WIDGET* viewport_widget ) const { return m_viewports.at( viewport_widget ).render_target; }
	...
	//private:
		...
		std::unordered_map<void*, VIEWPORT_DETAILS> m_viewports;
